...
export const apps: AppEntry[] = [
  ...
  },
  {
    ...
    reviews: [
      ...
      },
      {
        ...
        location: "Midtown",
        rating: 5,
        title: "Found my new reading spot",
        body: "There's a quiet atrium near my office I never knew was open to the public. Now I go there every week with a book.",
        date: "Sep 2025",
      },
      {
        author: "Tyler V.",
        ...
        body: "Really useful for the daily commute. The search is great and the list view makes it easy to scan fast.",
        date: "Aug 2025",
      },
    ],
  },
  {
    ...
    playStore: "https://play.google.com/store/apps/details?id=com.samuelsnow.shelftrack.android",
    itunesId: "6761561265",
    ...
    reviews: [
      ...
      },
      {
        author: "Rachel L.",
        rating: 5,
        title: "Organized my whole craft room",
        body: "Washi tape, beads, buttons — I used to buy duplicates all the time. Now I check Shelf Track before I order anything.",
        date: "Oct 2025",
      },
      {
        author: "dave_in_denver",
        rating: 4,
        title: "Great start, easy to use",
        body: "Clean interface and the shelf metaphor makes sense immediately. Looking forward to more sorting options in the future.",
        date: "Sep 2025",
      },
      {
        author: "Karen P.",
        ...
        body: "Simple, fast, and the sync works. I run a small business out of my home and this keeps inventory stress-free.",
        date: "Aug 2025",
      },
    ],
    faqs: [
